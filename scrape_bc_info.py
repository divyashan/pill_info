...
driver_path ='/Users/divyas/Library/Mobile Documents/com~apple~CloudDocs/Documents/real_docs/G2/chromedriver_80'
...
if collect_links == True:
    ...
    # Hard-coded - set this to the number of pages you would like to scrape
	n_pages = 11
	all_links = []
